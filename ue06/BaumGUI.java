    ...
    class AktionsAbhoerer implements java.awt.event.ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent event) {
            ...
            if ((object == einfuegenDruckknopf) || (object == entfernenDruckknopf) || (object == suchenDruckknopf)) {
                ...
                einBaum.attach(new Knoten<Character>('E',
                        new Knoten<Character>('D', new Knoten<Character>('A', null, null), null),
                        new Knoten<Character>('S', new Knoten<Character>('O', null,
                                new Knoten<Character>('P', null,
                                        new Knoten<Character>('R', new Knoten<Character>('Q', null, null), null))),
                                new Knoten<Character>('Z', null, null))));
